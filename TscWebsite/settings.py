"""
Django settings for TscWebsite project.
...
SECRET_KEY = '-6tw*g)1k6al9m@^8q14)wxx+m4js#0o3t_lyou7s01=7dp7g='
...
INSTALLED_APPS = [
    ...
    'reversion',
    'django_filters',
    'backend.extra_apps.xadmin',
    'backend.extra_apps.DjangoUeditor',
    # 'backend.apps.users',
    'backend.apps.tsc',
...
WSGI_APPLICATION = 'TscWebsite.wsgi.application'

# Database
# https://docs.djangoproject.com/en/1.11/ref/settings/#databases
DATABASE_URL = "192.168.204.128"
DATABASES = {
    'default': {
